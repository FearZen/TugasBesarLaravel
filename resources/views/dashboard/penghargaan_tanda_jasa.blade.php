...
<!-- <div style="width: 1440px; height: 1709px; position: relative; background: white"> -->
  <div style="width: 386.50px; height: 194.50px; left: 1142px; top: 81px; position: absolute">
    ...
    <div style="left: 14px; top: 35px; position: absolute; color: white; font-size: 26px; font-family: Fredoka One; font-weight: 400; word-wrap: break-word">Penghargaan/Tanda Jasa</div>
...
<a href="{{ route('penghargaan_tanda_jasa') }}" style="text-decoration: none; color: inherit;">
    <div class="icon-container" style="left: 41px; top: 477px;">
        <i class="fas fa-award" style="color: #FF5054;"></i>
    </div>
    <div class="text-container" style="left: 100px; top: 477px; color: #FF5054;">Penghargaan/Tanda Jasa</div>
</a>
...
<!-- Keterangan Penghargaan/Tanda Jasa -->
<div style="left: 507px; top: 500px; position: absolute; color: #1E1E1E; font-size: 24px; font-family: Gowun Dodum; font-weight: 400; word-wrap: break-word; margin-bottom: 20px;">
    <label for="keterangan_kegiatan">Keterangan Penghargaan/Tanda Jasa</label>
...
<div style="left: 507px; top: 954px; position: absolute; color: #1E1E1E; font-size: 24px; font-family: Gowun Dodum; font-weight: 400; word-wrap: break-word; margin-bottom: 30px;">
...
<!-- Nomor SK Kegiatan -->
<div style="left: 507px; top: 1071px; position: absolute; color: #1E1E1E; font-size: 24px; font-family: Gowun Dodum; font-weight: 400; word-wrap: break-word; margin-bottom: 30px;">
