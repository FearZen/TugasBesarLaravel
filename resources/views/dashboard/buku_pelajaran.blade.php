...
<!-- <div style="width: 1440px; height: 1709px; position: relative; background: white"> -->
  <div style="width: 386.50px; height: 194.50px; left: 1142px; top: 81px; position: absolute">
    ...
    <div style="left: 55px; top: 35px; position: absolute; color: white; font-size: 29px; font-family: Fredoka One; font-weight: 400; word-wrap: break-word">Buku Pelajaran</div>
...
<a href="{{ route('buku_pelajaran') }}" style="text-decoration: none; color: inherit;">
    <div class="icon-container" style="left: 41px; top: 556px;">
        <i class="fas fa-book-open" style="color: #FF5054;"></i>
    </div>
    <div class="text-container" style="left: 100px; top: 556px; color: #FF5054;">Buku Pelajaran</div>
</a>
...
<!-- Nomor SK Kegiatan -->
<div style="left: 507px; top: 931px; position: absolute; color: #1E1E1E; font-size: 24px; font-family: Gowun Dodum; font-weight: 400; word-wrap: break-word; margin-bottom: 30px;">
