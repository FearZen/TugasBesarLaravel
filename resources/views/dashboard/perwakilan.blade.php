...
<!-- <div style="width: 1440px; height: 1709px; position: relative; background: white"> -->
  <div style="width: 386.50px; height: 194.50px; left: 1142px; top: 81px; position: absolute">
    ...
    <div style="left: 75px; top: 35px; position: absolute; color: white; font-size: 29px; font-family: Fredoka One; font-weight: 400; word-wrap: break-word">Perwakilan</div>
...
<a href="{{ route('perwakilan') }}" style="text-decoration: none; color: inherit;">
    <div class="icon-container" style="left: 41px; top: 323px;">
        <i class="fas fa-building" style="color: #FF5054;"></i>
    </div>
    <div class="text-container" style="left: 100px; top: 323px; color: #FF5054;">Perwakilan</div>
</a>
